...
resizeRouter.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        (0, resize_image_1.default)(fileName, fileExtension, parseInt(width), parseInt(height), path_1.default.join(__dirname, '/../images'), path_1.default.join(__dirname, '../images/thumbnails/'))
