...
resizeRouter.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var fileName, fileExtension, width, height, fullFileName, RequestAvailable;
    return __generator(this, function (_a) {
        ...
        fullFileName = (0, utils_1.getImageName)(fileName, fileExtension, width, height);
        RequestAvailable = (0, utils_1.isImageAvailable)(fullFileName);
        if (RequestAvailable) {
        ...
        (0, resize_image_1.default)(fileName, fileExtension, parseInt(width), parseInt(height), path_1.default.join(__dirname, '/../images/'), path_1.default.join(__dirname, '/../images/'))
